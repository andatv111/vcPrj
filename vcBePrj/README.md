...
| GET | `/api/vc/specmaster/selectleftpaging` | SpecMaster 좌측 Master Grid |
| GET | `/api/vc/specmaster/{specId}/children` | SpecMaster 우측 Detail Grid |
...
SpecMaster의 GoodDocs API별 사용 판단과 B/E 협의 포인트는 root [md/SPEC_MASTER_DEVELOPMENT_GUIDE.md](../md/SPEC_MASTER_DEVELOPMENT_GUIDE.md)를 기준으로 봅니다.
