...
| GET | `/api/vc/code/getFabOptions` | SpecMaster 검색조건 FAB 후보 |
| GET | `/api/vc/code/getSpecMModelOptions?fabId=` | 선택 FAB의 SpecMaster MODEL 후보 |
| GET | `/api/vc/code/getMSpecNMs?fabId=&specNm=` | FAB 범위 Spec Name 포함 검색 |
| GET | `/api/vc/specmaster/selectfilteroptions` | SpecMaster 팝업 콤보 후보 |
| POST | `/api/vc/specmaster/selectcondition` | SpecMaster Master/Detail 전체 목록 |
| GET | `/api/vc/specmaster/{specId}` | SpecMaster 단건 조회 |
| GET | `/api/vc/specmaster/{specId}/children` | SpecMaster Detail 목록 조회 |
...
- SpecMaster popup options read through `GET /api/vc/specmaster/selectfilteroptions` when the popup opens.
