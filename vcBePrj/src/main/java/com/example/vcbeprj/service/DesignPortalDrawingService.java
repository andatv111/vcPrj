...
public class DesignPortalDrawingService {
    ...
    public DesignPortalDrawingService(TxtTableRepository repository, VcSpecMasterService specMasterService) {
    ...
    public List<DesignPortalDrawing> searchManualDrawings(String fabCd, String eqId, String woId) {
        ...
        List<DesignPortalDrawing> rows = repository.selectAll(PORTAL_TABLE, DesignPortalDrawing.class).stream()
    ...
    public List<DesignPortalDrawing> searchEquipmentSuggestions(String keyword) {
        ...
        return repository.selectAll(PORTAL_TABLE, DesignPortalDrawing.class).stream()
    ...
    public List<String> fabs() {
        List<String> portalFabs = repository.selectAll(PORTAL_TABLE, DesignPortalDrawing.class).stream()
